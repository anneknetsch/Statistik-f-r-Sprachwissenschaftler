...
Die Daten für die Mittelwerte aller Trials innerhalb eines Items zeigen weniger Varianz als die Mittelwerte aller Trials innerhalb einer Person. D.h. die Items über verschiedene Personen hinweg sind stabiler als die Personen über verschiedene Items hinweg. Bei den Single-Trial-Daten gibt es viel mehr Ausreißer und es ist fast keinen Unterschied zwischen den einzelnen Bedingungen (DD, DE, ED, EE) zu erkennen.
...
```{r,results='asis'}
priming.f1.englisch.target <- ezANOVA(subset(priming, target == "D")
                                      , dv=.(RT)
                                      , wid=.(subj)
                                      , within=.(prime)
                                      , detailed=TRUE
