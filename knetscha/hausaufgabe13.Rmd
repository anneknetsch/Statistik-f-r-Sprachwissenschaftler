...
Die Daten für die Mittelwerte aller Trials innerhalb eines Items zeigen weniger Varianz als die Mittelwerte aller Trials innerhalb einer Person. D.h. die Items über verschiedene Personen hinweg sind stabiler als die Personen über verschiedene Items hinweg. Bei den Single-Trial-Daten gibt es viel mehr Ausreißer und es ist fast kein Unterschied zwischen den einzelnen Bedingungen (DD, DE, ED, EE) zu erkennen.
